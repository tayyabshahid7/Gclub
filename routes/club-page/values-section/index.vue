<template>
  <div class="my-7 lg:my-20">
    <div class="text-center content-center justify-center lg:mb-20 md:py-7">
      <h1
        class="uppercase text-md tracking-widest text-app-brass font-acumin text-widest"
      >
        our values
      </h1>
    </div>
    <div
      class="flex flex-wrap justify-center flex-col md:flex-row md:space-x-12 my-12 mx-6 md:mx-12"
    >
      <div
      ...
      >
        ...
        />
        <p
          class="text-xl lg:text-2xl font-thin uppercase text-app-brass font-ivy-presto my-9"
        >
          Value
        </p>
